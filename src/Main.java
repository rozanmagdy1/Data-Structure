...
//                " and front is " + dq.getFront());
//
//        System.out.println("inserting element 13 at front end");
//        dq.insertFront(13);
//
...
//
//        Graph.Vertex v1 = graph.new Vertex(1);
//        Graph.Vertex v2 = graph.new Vertex(2);
//        Graph.Vertex v3 = graph.new Vertex(3);
//
//        graph.addVertex(v1);
//        graph.addVertex(v2);
//        graph.addVertex(v3);
